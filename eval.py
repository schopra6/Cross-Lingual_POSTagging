...
overall_recall =0
overall_f1=0
precision_recall = collections.OrderedDict(sorted(precision_recall.items()))
...
total=len(precision_recall.items())
print("%.4f & %.4f & %.4f" % ((overall_precision / total), (overall_recall / total),  (overall_f1 / total)))
print("\nAccuracy: %.4f\n" % (correct / overall))